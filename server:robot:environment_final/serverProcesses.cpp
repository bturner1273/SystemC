...
void Server:: robotStopped(){
  grid map;
  map.makeGrid();
  if(stop1 && !done1){
     cout << "@"<<sc_time_stamp()<<" robot1 is at speed "<<(r1speed.read()*1000)<<" m/s"<<endl;
       cout << "@"<<sc_time_stamp()<<" robot2 is at speed "<<(r2speed.read()*1000)<<" m/s"<<endl;
       cout << "@"<<sc_time_stamp()<<" robot3 is at speed "<<(r3speed.read()*1000)<<" m/s"<<endl;
       cout << "@"<<sc_time_stamp()<<" robot4 is at speed "<<(r4speed.read()*1000)<<" m/s"<<endl;
    cout << "@" << sc_time_stamp()<<" robot1 responds to obstacle"<<endl;
    map.setPosp1(nextPos1.read());
    map.setPos1(currentPos1.read());
    map.setPos2(currentPos2.read());
    map.setPos3(currentPos3.read());
    map.setPos4(currentPos4.read());
    map.printPeople();
  }
  if(stop2 && !done2){
     cout << "@"<<sc_time_stamp()<<" robot1 is at speed "<<(r1speed.read()*1000)<<" m/s"<<endl;
       ...
       cout << "@"<<sc_time_stamp()<<" robot3 is at speed "<<(r3speed.read()*1000)<<" m/s"<<endl;
       cout << "@"<<sc_time_stamp()<<" robot4 is at speed "<<(r4speed.read()*1000)<<" m/s"<<endl;
    cout << "@" << sc_time_stamp()<<" robot2 responds to obstacle"<<endl;
    map.setPosp1(nextPos2.read());
    map.setPos1(currentPos1.read());
    map.setPos2(currentPos2.read());
    map.setPos3(currentPos3.read());
    map.setPos4(currentPos4.read());
  ...
  if(stop3 && !done3){
     cout << "@"<<sc_time_stamp()<<" robot1 is at speed "<<(r1speed.read()*1000)<<" m/s"<<endl;
       ...
       cout << "@"<<sc_time_stamp()<<" robot3 is at speed "<<(r3speed.read()*1000)<<" m/s"<<endl;
       cout << "@"<<sc_time_stamp()<<" robot4 is at speed "<<(r4speed.read()*1000)<<" m/s"<<endl;
    cout << "@" << sc_time_stamp()<<" robot3 responds to obstacle"<<endl;
    map.setPosp1(nextPos3.read());
    map.setPos1(currentPos1.read());
    map.setPos2(currentPos2.read());
    map.setPos3(currentPos3.read());
    map.setPos4(currentPos4.read());
  ...
  if(stop4 && !done4){
     cout << "@"<<sc_time_stamp()<<" robot1 is at speed "<<(r1speed.read()*1000)<<" m/s"<<endl;
       ...
       cout << "@"<<sc_time_stamp()<<" robot3 is at speed "<<(r3speed.read()*1000)<<" m/s"<<endl;
       cout << "@"<<sc_time_stamp()<<" robot4 is at speed "<<(r4speed.read()*1000)<<" m/s"<<endl;
    cout << "@" << sc_time_stamp()<<" robot4 responds to obstacle"<<endl;
    map.setPosp1(nextPos4.read());
    map.setPos1(currentPos1.read());
    map.setPos2(currentPos2.read());
    map.setPos3(currentPos3.read());
    map.setPos4(currentPos4.read());
  ...
  //now we have a grid and we will print position of human robot collision because we know person is at robot.nextPOS();
