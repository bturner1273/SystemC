...
int sc_main (int argc, char* argv[]) {
  ...
  sc_signal<int> currentPos1, nextPos1, currentPos2, nextPos2, currentPos3, nextPos3, currentPos4, nextPos4, person1, person2, person3;
  ...
  env.nextPos1(nextPos1);
  env.nextPos2(nextPos2);
  env.nextPos3(nextPos3);
  env.nextPos4(nextPos4);
  env.clock(clock);
  env.stop1(stop1);
  env.stop2(stop2);
  env.stop3(stop3);
